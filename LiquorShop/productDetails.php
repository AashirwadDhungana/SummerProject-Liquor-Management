...
<body >
	...
	<div class="container-fluid container">
		...
		<?php
			$query3="SELECT product_name,product_brand,product_category,product_price,product_size,product_abv,product_description,product_image,product_quantity FROM product WHERE product_id='$p_id'";
			$result3=mysqli_query($sql_connection,$query3);
			while($row=mysqli_fetch_assoc($result3)){
		...
		<div class="row">
			...
			<div class="col-md-5"  style="float:right">
				<div  style="border-radius: 25px" class="thumbnail ">
					...
					<form method="post">
							Quantity
							<input type="number" name="Quantity" min="1" max="3" step="1" value="1">
							<br>
...
<?php
	...
	if(isset($_POST['addcart'])){
		...
		if(!isset($_SESSION['userid'])){
			...
			$query4="INSERT INTO cart (cart_user_id,cart_product_id,cart_Quantity,cart_total_price) VALUES('$id','$p_id','$Quantity','$total')";
