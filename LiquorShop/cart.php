		...
		<h2 class='text-center'>Cart</h2>
			...
			<?php
				...
				while($row=mysqli_fetch_assoc($result4)){
					...
					echo "<h4>Quantity: ".$row['cart_quantity']."</h4>";
					echo "<h4>Total: NPR ".$row['cart_total_price']." .00</h4>";
					...
					echo "<a href='cart.php?order=$productid&Quantity=$Quantity&total=$total&cartid=$cartid' class='viewbtn'>order</a>";
					echo "</div>";
					echo "</td>";
					echo "</tr>";
				...
				if(isset($_GET['order'])){
					...
					$total=$_GET['total'];
					$query6="insert into orders (order_user_id,order_product_id,order_Quantity,order_total_price,order_status) values ('$id','$productid','$Quantity','$total','New')";
