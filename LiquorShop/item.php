	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="admin.php">THE OAK STORE - Admin</a>
			</div>
	...
	<div class="container">
		...
		<?php
			...
			if($status=='add'){
				...
				Price (NPR)<br><input type='text' name='price' required><br>
				...
				<br>
				Stock <br><input type='number' name='Stock' required><br>
				...
				if(isset($_POST['item_add'])){
					...
					$query5="insert into product (product_name,product_brand,product_category,product_price,product_size,product_abv,product_description,product_image,Stock) values ('$name','$brand','$category','$price','$size','$abv','$description','$image','$Stock')";
