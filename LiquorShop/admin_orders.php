...
<?php	
	...
	if(isset($_SESSION['userid'])){
		...
		$signupBtn= "<a href='admin_user.php'>Hi! ".$name."</a>";
		...
		<?php
			...
			if($status=='new'){
				...
				while($row=mysqli_fetch_assoc($result4)){
					...
					echo "</td>";
					echo "<td>";
					echo "NPR ".$row['order_total_price']." .00";
					echo "</td>";
					echo "<td>";
					echo $row['order_date'];
					echo "</td>";
					...
					echo "<td><a href='admin_orders.php?ship=$order_id&id=$id&qty=$qty' class='viewbtn'>Ship</a></td>";
...
$sql="UPDATE product SET product_quantity=product_quantity-'$pqty' WHERE product_id='$pid'";
